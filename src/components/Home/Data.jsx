...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Siqi Wang
                <svg className="home__hand" xmlns="http://www.w3.org/2000/svg" id="emoji"  viewBox="0 0 72 72" version="1.1">
                    <g id="hair" />
                    <g id="skin">
                ...
                <h3 className="home__subtitle">Control Scientist</h3>
                <p className="home__description">Hi! I'm a master student in Shanghai Jiao Tong University in Shanghai, China. Welcome to my home page.</p>
                <a href="#contact" className="button button--flex">
                    Say Hello 
                    <i className="bi bi-chat home__chat"/> 
                </a>
